! function() {
	...
	function Q(t, e, i) {
		return (($(e, i) * t + G(e, i)) * t + J(e)) * t
	}

	function Z(t, e, i) {
		return 3 * $(e, i) * t * t + 2 * G(e, i) * t + J(e)
	}
	...
	var et = function(t, e, i, s) {
			...
			for (var n = U ? new Float32Array(11) : new Array(11), o = 0; o < 11; ++o) n[o] = Q(o * N, t, i);

			function l(e) {
				for (var s = 0, o = 1; 10 !== o && n[o] <= e; ++o) s += N;
				--o;
				var l = s + (e - n[o]) / (n[o + 1] - n[o]) * N,
					r = Z(l, t, i);
				return r >= .001 ? function(t, e, i, s) {
					...
					var o, l, r = 0;
					do {
						(o = Q(l = e + (i - e) / 2, s, n) - t) > 0 ? i = l : e = l
					} while (Math.abs(o) > 1e-7 && ++r < 10);
					return l
				}(e, s, s + N, t, i)
			}
			return function(t) {
				return 0 === t ? 0 : 1 === t ? 1 : Q(l(t), e, s)
			}
		},
		it = 38,
		st = 40,
		...
		dt = function() {
			...
			return i(e, [{
				key: "init",
				value: function() {
					if (this.options.isMobile = /Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || "MacIntel" === navigator.platform && navigator.maxTouchPoints > 1 || window.innerWidth < this.tablet.breakpoint, this.options.isTablet = this.options.isMobile && window.innerWidth >= this.tablet.breakpoint, this.smooth && !this.options.isMobile || this.tablet.smooth && this.options.isTablet || this.smartphone.smooth && this.options.isMobile && !this.options.isTablet ? this.scroll = new ht(this.options) : this.scroll = new S(this.options), this.scroll.init(), window.location.hash) {
	...
	! function() {
		...
		"true" == document.querySelector("#js-scroll").getAttribute("data-horizontal") && (t.direction = "horizontal", t.gestureDirection = "both", t.tablet = {
			...
			e.on("scroll", (function(t) {
				...
				e.el.style.backgroundColor = "hsl(".concat(n, ", 11%, 85%)"), i.forEach((function(t) {
					t.el.style.backgroundColor = "hsl(".concat(n, ", 11%, 85%)")
				})), s.forEach((function(t) {
					t.el.style.color = "hsl(".concat(n, ", 11%, 85%)")
